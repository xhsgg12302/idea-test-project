 ...
 *
 * see:
 *      1. https://github.com/XTLS/Xray-core/issues/158
 *      2. https://stackoverflow.com/questions/40230276/how-to-make-a-type-5-uuid-in-java
 *
 *
 * @date 2024/5/5
 *                          @since  1.0
...
public class UUIDType5 {
    ...
    public static void main(String[] args) {
        UUID NAMESPACE_DNS = UUID.fromString("00000000-0000-0000-0000-000000000000");
        UUID test = UUIDType5.nameUUIDFromNamespaceAndString(NAMESPACE_DNS, "example");
